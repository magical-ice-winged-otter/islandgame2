...
AI_SINGLE_BATTLE_TEST("AI_FLAG_SMART_SWITCHING: AI will switch out if it has an absorber")
{
    ...
    PARAMETRIZE { aiMon = SPECIES_CHINCHOU; absorbingAbility = ABILITY_VOLT_ABSORB; move = MOVE_THUNDERBOLT;}
    ...
    PARAMETRIZE { aiMon = SPECIES_WHISMUR; absorbingAbility = ABILITY_SOUNDPROOF; move = MOVE_HYPER_VOICE;}
    GIVEN {

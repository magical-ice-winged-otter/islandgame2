...
RULES_NO_SCAN += libagbsyscall clean porytiles-clean clean-assets tidy tidymodern tidycheck generated clean-generated $(TESTELF)
.PHONY: all rom agbcc modern compare check debug porytiles
.PHONY: $(RULES_NO_SCAN)

...
RULES_NO_SCAN += libagbsyscall clean porytiles-clean clean-assets tidy tidymodern tidynonmodern tidycheck generated clean-generated $(TESTELF)
.PHONY: all rom agbcc modern compare check porytiles
.PHONY: $(RULES_NO_SCAN)

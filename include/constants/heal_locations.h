...
enum {
    ...
    HEAL_LOCATION_CHERIPORT,
    HEAL_LOCATION_ISLANDGAME_CAMP_PERSI,
    HEAL_LOCATION_ISLANDGAME_FRESA_FARMS,
    HEAL_LOCATION_ISLANDGAME_TIDALCOVE,
    HEAL_LOCATION_ISLANDGAME_ROSEVALE,
    HEAL_LOCATION_ISLANDGAME_MAPLEGROVE,
    HEAL_LOCATION_ISLANDGAME_APPLEVINE,
    NUM_HEAL_LOCATIONS
};

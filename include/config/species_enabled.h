...
#define P_FAMILY_NINCADA_MARYAN          P_GEN_C_POKEMON
#define P_FAMILY_COMBEE_MARYAN           P_GEN_C_POKEMON
#define P_FAMILY_SHADOW_AGGRON           P_GEN_C_POKEMON
#define P_FAMILY_ANOMALY_01              P_GEN_C_POKEMON
#define P_FAMILY_SHELLOS_MARYAN          P_GEN_C_POKEMON
#define P_FAMILY_SKITTY_MARYAN           P_GEN_C_POKEMON

...
static const Location LOCATION_DATA[] = {
    ...
    [CENTRAL_ORANNA] = SET_LOC(ISLANDGAME_CENTRAL_ORANNA_PATH_1, 67, 41),
    [ROSEVALE] = SET_LOC(ISLANDGAME_ROSEVALE, 49, 9),
};
...
#define START_LOC_GAME LOCATION_DATA[MINTY_MEADOWS]

...
extern const u32 gTrainerFrontPic_Aceron[];
extern const u32 gTrainerFrontPic_Alecran[];
extern const u32 gTrainerFrontPic_Brega[];
extern const u32 gTrainerFrontPic_Ceres[];
extern const u32 gTrainerFrontPic_Delos[];
extern const u32 gTrainerFrontPic_Duo[];
extern const u32 gTrainerFrontPic_Electro[];
extern const u32 gTrainerFrontPic_Fantina[];
extern const u32 gTrainerFrontPic_Fausto[];
extern const u32 gTrainerFrontPic_Gaia[];
extern const u32 gTrainerFrontPic_Gardenia[];
extern const u32 gTrainerFrontPic_Helio[];
extern const u32 gTrainerFrontPic_Inverna[];
extern const u32 gTrainerFrontPic_Israel[];
extern const u32 gTrainerFrontPic_Gambler[];
extern const u32 gTrainerFrontPic_Mananti[];
extern const u32 gTrainerFrontPic_Roco[];
extern const u32 gTrainerFrontPic_Saturno[];
extern const u32 gTrainerFrontPic_Venus[];
extern const u32 gTrainerFrontPic_Artist[];
extern const u32 gTrainerFrontPic_Bald[];
extern const u32 gTrainerFrontPic_BirdkeeperF[];
extern const u32 gTrainerFrontPic_Clown[];
extern const u32 gTrainerFrontPic_CooltrainerSnowF[];
extern const u32 gTrainerFrontPic_CooltrainerSnowM[];
extern const u32 gTrainerFrontPic_Cowboy[];
extern const u32 gTrainerFrontPic_Cowgirl[];
extern const u32 gTrainerFrontPic_Cynthia[];
extern const u32 gTrainerFrontPic_FarmerDuo[];
extern const u32 gTrainerFrontPic_InterviewerF[];
extern const u32 gTrainerFrontPic_InterviewerM[];
extern const u32 gTrainerFrontPic_Jogger[];
extern const u32 gTrainerFrontPic_OldLady[];
extern const u32 gTrainerFrontPic_PikachuGirl[];
extern const u32 gTrainerFrontPic_Police[];
extern const u32 gTrainerFrontPic_PopIdol[];
extern const u32 gTrainerFrontPic_Scientist[];
extern const u32 gTrainerFrontPic_SkiF[];
extern const u32 gTrainerFrontPic_SkiM[];
extern const u32 gTrainerFrontPic_SwimmerTuberDuo[];
...
extern const u32 gTrainerPalette_Acerón[];
extern const u32 gTrainerPalette_Alecran[];
extern const u32 gTrainerPalette_Brega[];
extern const u32 gTrainerPalette_Ceres[];
extern const u32 gTrainerPalette_Delos[];
extern const u32 gTrainerPalette_Duo[];
extern const u32 gTrainerPalette_Electro[];
extern const u32 gTrainerPalette_Fantina[];
extern const u32 gTrainerPalette_Fausto[];
extern const u32 gTrainerPalette_Gaia[];
extern const u32 gTrainerPalette_Gardenia[];
extern const u32 gTrainerPalette_Helio[];
extern const u32 gTrainerPalette_Inverna[];
extern const u32 gTrainerPalette_Israel[];
extern const u32 gTrainerPalette_Gambler[];
extern const u32 gTrainerPalette_Mananti[];
extern const u32 gTrainerPalette_Roco[];
extern const u32 gTrainerPalette_Saturno[];
extern const u32 gTrainerPalette_Venus[];
extern const u32 gTrainerPalette_Artist[];
extern const u32 gTrainerPalette_Bald[];
extern const u32 gTrainerPalette_BirdkeeperF[];
extern const u32 gTrainerPalette_Clown[];
extern const u32 gTrainerPalette_CooltrainerSnowF[];
extern const u32 gTrainerPalette_CooltrainerSnowM[];
extern const u32 gTrainerPalette_Cowboy[];
extern const u32 gTrainerPalette_Cowgirl[];
extern const u32 gTrainerPalette_Cynthia[];
extern const u32 gTrainerPalette_FarmerDuo[];
extern const u32 gTrainerPalette_InterviewerF[];
extern const u32 gTrainerPalette_InterviewerM[];
extern const u32 gTrainerPalette_Jogger[];
extern const u32 gTrainerPalette_OldLady[];
extern const u32 gTrainerPalette_PikachuGirl[];
extern const u32 gTrainerPalette_Police[];
extern const u32 gTrainerPalette_PopIdol[];
extern const u32 gTrainerPalette_Scientist[];
extern const u32 gTrainerPalette_SkiF[];
extern const u32 gTrainerPalette_SkiM[];
extern const u32 gTrainerPalette_SwimmerTuberDuo[];

...
static const u8 sMapHealLocations[][3] =
{
    ...
    //ISLANDGAME START
    [MAPSEC_CHERIPORT] = {MAP_GROUP(MAP_ISLANDGAME_CHERIPORT), MAP_NUM(MAP_ISLANDGAME_CHERIPORT), HEAL_LOCATION_CHERIPORT},
    [MAPSEC_PERSI] = {MAP_GROUP(MAP_ISLANDGAME_CAMP_PERSI), MAP_NUM(MAP_ISLANDGAME_CAMP_PERSI), HEAL_LOCATION_ISLANDGAME_CAMP_PERSI},
    [MAPSEC_FRESA_FARMS] = {MAP_GROUP(MAP_ISLANDGAME_FRESA_FARMS), MAP_NUM(MAP_ISLANDGAME_FRESA_FARMS), HEAL_LOCATION_FRESA_FARMS},
    [MAPSEC_TIDALCOVE] = {MAP_GROUP(MAP_ISLANDGAME_TIDALCOVE), MAP_NUM(MAP_ISLANDGAME_TIDALCOVE), HEAL_LOCATION_TIDALCOVE},
    [MAPSEC_ROSEVALE] = {MAP_GROUP(MAP_ISLANDGAME_ROSEVALE), MAP_NUM(MAP_ISLANDGAME_ROSEVALE), HEAL_LOCATION_ROSEVALE},
    [MAPSEC_MAPLEGROVE] = {MAP_GROUP(MAP_ISLANDGAME_MAPLEGROVE), MAP_NUM(MAP_ISLANDGAME_MAPLEGROVE), HEAL_LOCATION_MAPLEGROVE},
    [MAPSEC_APPLEVINE] = {MAP_GROUP(MAP_ISLANDGAME_APPLEVINE), MAP_NUM(MAP_ISLANDGAME_APPLEVINE), HEAL_LOCATION_APPLEVINE},
};

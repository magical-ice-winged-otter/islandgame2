...
static const u16 sRegionMapPlayerIcon_BrendanPal[] = INCBIN_U16("graphics/pokenav/region_map/oliver_icon.gbapal");
static const u8 sRegionMapPlayerIcon_BrendanGfx[] = INCBIN_U8("graphics/pokenav/region_map/oliver_icon.4bpp");
static const u16 sRegionMapPlayerIcon_MayPal[] = INCBIN_U16("graphics/pokenav/region_map/olivia_icon.gbapal");
static const u8 sRegionMapPlayerIcon_MayGfx[] = INCBIN_U8("graphics/pokenav/region_map/olivia_icon.4bpp");
...
static const u8 sMapHealLocations[][3] =
{
    ...
    //ISLANDGAME START
    [MAPSEC_CHERIPORT] = {MAP_GROUP(ISLANDGAME_CHERIPORT), MAP_NUM(ISLANDGAME_CHERIPORT), HEAL_LOCATION_CHERIPORT},
    [HEAL_LOCATION_ISLANDGAME_CAMP_PERSI - 1] = { .mapGroup = MAP_GROUP(ISLANDGAME_CAMP_PERSI), .mapNum = MAP_NUM(ISLANDGAME_CAMP_PERSI), .x = 47, .y = 30 },
    [HEAL_LOCATION_ISLANDGAME_FRESA_FARMS - 1] = { .mapGroup = MAP_GROUP(ISLANDGAME_FRESA_FARMS), .mapNum = MAP_NUM(ISLANDGAME_FRESA_FARMS), .x = 22, .y = 10 },
    [HEAL_LOCATION_ISLANDGAME_TIDALCOVE - 1] = { .mapGroup = MAP_GROUP(ISLANDGAME_TIDALCOVE), .mapNum = MAP_NUM(ISLANDGAME_TIDALCOVE), .x = 21, .y = 39 },
    [HEAL_LOCATION_ISLANDGAME_ROSEVALE - 1] = { .mapGroup = MAP_GROUP(ISLANDGAME_ROSEVALE), .mapNum = MAP_NUM(ISLANDGAME_ROSEVALE), .x = 23, .y = 27 },
    [HEAL_LOCATION_ISLANDGAME_MAPLEGROVE - 1] = { .mapGroup = MAP_GROUP(ISLANDGAME_MAPLEGROVE), .mapNum = MAP_NUM(ISLANDGAME_MAPLEGROVE), .x = 6, .y = 16 },
    [HEAL_LOCATION_ISLANDGAME_APPLEVINE - 1] = { .mapGroup = MAP_GROUP(ISLANDGAME_APPLEVINE), .mapNum = MAP_NUM(ISLANDGAME_APPLEVINE), .x = 50, .y = 13 },
};

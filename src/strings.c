...
const u8 gText_PokevialHasDoses[] =_("The {STR_VAR_1} has {STR_VAR_2} doses remaining.\nUse the {STR_VAR_1}?");// Pokevial Branch
const u8 gText_PokevialIsEmpty[] =_("The {STR_VAR_1} is empty!\nRefill it by healing at a {STR_VAR_2}.{PAUSE_UNTIL_PRESS}"); // Pokevial Branch
const u8 gText_YourPkmnWereRestored[] =_("Your {STR_VAR_1} were restored to full health.{PAUSE_UNTIL_PRESS}"); // Pokevial Branch

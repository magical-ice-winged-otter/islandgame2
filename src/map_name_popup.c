...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    // oranna
    [MAPSEC_SS_RAIN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_CHERIPORT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_MINTY_MEADOWS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_TRAVELERS_TUNNEL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_CENTRAL_ORANNA_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_SOUTHERN_ORANNA_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_VERDANT_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_VERDANT_WOODS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_FRESA_FARMS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_NORTHERN_ORANNA_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_ROSEVALE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_AURORA_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_MT_AURORA - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_MAPLEGROVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_PERSI - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_TIDALCOVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    // lumine
    [MAPSEC_APPLEVINE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_ROCKY_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_LUMINE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_BELLEHAVEN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_VALLEY_OF_PEACE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_BELLE_CATACOMBS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_PLEASANT_AVENUE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_AETHERIA - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_AZURE_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_ARBORIA - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_ARBORIA_THICKET - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_SIERRA_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_CANTALO - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_LUMINE_POWER_PLANT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_THERION_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_MT_THERION - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
    [MAPSEC_PROMENADE_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BLACK,
};

...
// Medicine
    ...
    {
        .name = _("Hyper Potion"),
        .price = (I_PRICE >= GEN_2 || I_PRICE <= GEN_6) ? 1200 : 3000,
        .holdEffectParam = 120,
        .description = COMPOUND_STRING(
            "Restores the HP of\n"
            "a Pokémon by\n"

...
const u32 gTrainerFrontPic_Audrey[] = INCBIN_U32("graphics/trainers/front_pics/audrey.4bpp.lz");
const u32 gTrainerPalette_Audrey[] = INCBIN_U32("graphics/trainers/front_pics/audrey.gbapal.lz");

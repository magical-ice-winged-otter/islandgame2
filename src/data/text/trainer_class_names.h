const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("{PKMN} Thief"), // Thief 
    ...
    [TRAINER_CLASS_BLACK_BELT] = _("Black "),
    ...
    [TRAINER_CLASS_SR_AND_JR] = _("Besties"),
    [TRAINER_CLASS_WINSTRATE] = _("Merchant"), // Jonas
    ...
    [TRAINER_CLASS_PIKE_QUEEN] = _("{PKMN} Idol"),

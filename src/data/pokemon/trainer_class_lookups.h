const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_OLIVER] = TRAINER_PIC_OLIVER,
    [FACILITY_CLASS_OLIVER_2] = TRAINER_PIC_OLIVER,
    [FACILITY_CLASS_OLIVER_3] = TRAINER_PIC_OLIVER,
    [FACILITY_CLASS_OLIVIA] = TRAINER_PIC_OLIVIA,
    [FACILITY_CLASS_OLIVIA_2] = TRAINER_PIC_OLIVIA,
    [FACILITY_CLASS_OLIVIA_3] = TRAINER_PIC_OLIVIA,
};

static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CHERIPORT - 1] = {MAP_GROUP(ISLANDGAME_CHERIPORT), MAP_NUM(ISLANDGAME_CHERIPORT), 32, 30},
    [HEAL_LOCATION_ISLANDGAME_CAMP_PERSI - 1] = {MAP_GROUP(ISLANDGAME_CAMP_PERSI), MAP_NUM(ISLANDGAME_CAMP_PERSI), 47, 30},
    [HEAL_LOCATION_ISLANDGAME_FRESA_FARMS - 1] = {MAP_GROUP(ISLANDGAME_FRESA_FARMS), MAP_NUM(ISLANDGAME_FRESA_FARMS), 22, 10},
    [HEAL_LOCATION_ISLANDGAME_TIDALCOVE - 1] = {MAP_GROUP(ISLANDGAME_TIDALCOVE), MAP_NUM(ISLANDGAME_TIDALCOVE), 21, 39},
    [HEAL_LOCATION_ISLANDGAME_ROSEVALE - 1] = {MAP_GROUP(ISLANDGAME_ROSEVALE), MAP_NUM(ISLANDGAME_ROSEVALE), 23, 27},
    [HEAL_LOCATION_ISLANDGAME_MAPLEGROVE - 1] = {MAP_GROUP(ISLANDGAME_MAPLEGROVE), MAP_NUM(ISLANDGAME_MAPLEGROVE), 6, 16},
    [HEAL_LOCATION_ISLANDGAME_APPLEVINE - 1] = {MAP_GROUP(ISLANDGAME_APPLEVINE), MAP_NUM(ISLANDGAME_APPLEVINE), 50, 13},
};

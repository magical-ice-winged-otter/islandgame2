static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ISLANDGAME_CAMP_PERSI - 1] = {MAP_GROUP(ISLANDGAME_CAMP_PERSI), MAP_NUM(ISLANDGAME_CAMP_PERSI), 17, 29},
    [HEAL_LOCATION_ISLANDGAME_FRESA_FARMS - 1] = {MAP_GROUP(ISLANDGAME_FRESA_FARMS), MAP_NUM(ISLANDGAME_FRESA_FARMS), 23, 10},
    [HEAL_LOCATION_ISLANDGAME_TIDALCOVE - 1] = {MAP_GROUP(ISLANDGAME_TIDALCOVE), MAP_NUM(ISLANDGAME_TIDALCOVE), 21, 41},
    [HEAL_LOCATION_ISLANDGAME_ROSEVALE - 1] = {MAP_GROUP(ISLANDGAME_ROSEVALE), MAP_NUM(ISLANDGAME_ROSEVALE), 27, 27},
    [HEAL_LOCATION_ISLANDGAME_MAPLEGROVE - 1] = {MAP_GROUP(ISLANDGAME_MAPLEGROVE), MAP_NUM(ISLANDGAME_MAPLEGROVE), 5, 32},
};

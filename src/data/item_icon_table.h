...
// Islandgame Custom Items
    ...
    [ITEM_ISLANDGAME_PICKAXE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_ISLANDGAME_POWERGLOVE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},

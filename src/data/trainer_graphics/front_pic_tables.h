const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ACERON] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_ALECRAN] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_BREGA] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_CERES] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_DELOS] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_DUO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_ELECTRO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_FANTINA] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_FAUSTO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_GAIA] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_GARDENIA] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_HELIO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_INVERNA] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_ISRAEL] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_GAMBLER] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_MANANTI] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_ROCO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_SATURNO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_VENUS] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_ARTIST] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_BALD] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_BIRDKEEPERF] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_CLOWN] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_COOLTRAINERSNOWF] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_COOLTRAINERSNOWM] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_COWBOY] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_COWGIRL] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_CYNTHIA] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_FARMERDUO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_INTERVIEWERF] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_INTERVIEWERM] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_JOGGER] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_OLDLADY] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_PIKACHUGIRL] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_POLICE] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_POPIDOL] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_SCIENTIST] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_SKIF] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_SKIM] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_SWIMMERTUBERDUO] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_WAITER] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_WAITRESS] = {.size = 8, .y_offset = 0},
    [TRAINER_PIC_WORKER] = {.size = 8, .y_offset = 0},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ACERON, gTrainerFrontPic_Aceron, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ALECRAN, gTrainerFrontPic_Alecran, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BREGA, gTrainerFrontPic_Brega, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CERES, gTrainerFrontPic_Ceres, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(DELOS, gTrainerFrontPic_Delos, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(DUO, gTrainerFrontPic_Duo, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELECTRO, gTrainerFrontPic_Electro, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(FANTINA, gTrainerFrontPic_Fantina, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(FAUSTO, gTrainerFrontPic_Fausto, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GAIA, gTrainerFrontPic_Gaia, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GARDENIA, gTrainerFrontPic_Gardenia, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(HELIO, gTrainerFrontPic_Helio, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(INVERNA, gTrainerFrontPic_Inverna, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ISRAEL, gTrainerFrontPic_Israel, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GAMBLER, gTrainerFrontPic_Gambler, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MANANTI, gTrainerFrontPic_Mananti, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ROCO, gTrainerFrontPic_Roco, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SATURNO, gTrainerFrontPic_Saturno, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(VENUS, gTrainerFrontPic_Venus, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ARTIST, gTrainerFrontPic_Artist, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BALD, gTrainerFrontPic_Bald, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BIRDKEEPERF, gTrainerFrontPic_BirdkeeperF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CLOWN, gTrainerFrontPic_Clown, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(COOLTRAINERSNOWF, gTrainerFrontPic_CooltrainerSnowF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(COOLTRAINERSNOWM, gTrainerFrontPic_CooltrainerSnowM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(COWBOY, gTrainerFrontPic_Cowboy, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(FARMERDUO, gTrainerFrontPic_FarmerDuo, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(INTERVIEWERF, gTrainerFrontPic_InterviewerF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(INTERVIEWERM, gTrainerFrontPic_InterviewerM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(JOGGER, gTrainerFrontPic_Jogger, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(OLDLADY, gTrainerFrontPic_OldLady, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PIKACHUGIRL, gTrainerFrontPic_PikachuGirl, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(POLICE, gTrainerFrontPic_Police, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(POPIDOL, gTrainerFrontPic_PopIdol, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SCIENTIST, gTrainerFrontPic_Scientist, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SKIF, gTrainerFrontPic_SkiF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SKIM, gTrainerFrontPic_SkiM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SWIMMERTUBERDUO, gTrainerFrontPic_SwimmerTuberDuo, TRAINER_PIC_SIZE),

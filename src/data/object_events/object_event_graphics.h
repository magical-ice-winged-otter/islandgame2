...
const u32 gFieldEffectObjectPic_ShockWave[] = INCBIN_U32("graphics/field_effects/pics/lightning.4bpp");
const u16 gFieldEffectObjectPalette_ShockWave[] = INCBIN_U16("graphics/field_effects/pics/lightning.gbapal");

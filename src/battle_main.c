...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_SR_AND_JR] = { _("Besties"), 4 },
    ...
    case EFFECT_HIDDEN_POWER:
        {
            ...
            // Subtract 7 instead of 1 below because 7 types are excluded (TYPE_NONE, TYPE_NORMAL, TYPE_MYSTERY, TYPE_FAIRY, TYPE_STELLAR and TYPE_SHADOW)

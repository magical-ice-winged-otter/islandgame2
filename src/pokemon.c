...
#if P_LVL_UP_LEARNSETS >= GEN_C
#include "data/pokemon/level_up_learnsets/gen_shadow.h" // islandgame-add our custom generation
...
const u8 *GetTrainerPartnerName(void)
{
    ...
    {
        if (gPartnerTrainerId < TRAINER_PARTNER(PARTNER_COUNT))
        {

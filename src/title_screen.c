...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/wingsofchaos_bg_tiles.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/wingsofchaos_bg_tiles.bin.lz");
...
UNUSED static void UpdateLegendaryMarkingColor(u8 frameNum)
{

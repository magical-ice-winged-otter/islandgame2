...
do
  ...
  if [[ "$type" == "primary" ]]; then
    ...
    $PORYTILES compile-primary -o $ISLAND_DIR/data/tilesets/primary/$data_dir/ $ISLAND_DIR/porytiles/$pory_dir/primary/
  elif [[ "$type" == "secondary" ]]; then
    echo "$pory_dir/$type --> $data_dir + $primary_pory_dir/primary"
    $PORYTILES compile-secondary -o $ISLAND_DIR/data/tilesets/secondary/$data_dir/ $ISLAND_DIR/porytiles/$pory_dir/secondary $ISLAND_DIR/porytiles/$primary_pory_dir/primary
